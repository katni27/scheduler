...
Программа для автоматического составления расписания в университете

Java 17 | Maven 3 | OptaPlanner 9.44

## Интерфейс программы

**Реализация интерфейса не приведена в репозитории**

Графический интерфейс разработан при помощи библиотеки Swing

### Сформированное расписание для учебных групп
<img src="images/image_1.png" alt="Расписание для учебных групп" width="600" />

### Редактирование занятия
<img src="images/image_2.png" alt="Окно редактирования занятия" width="600" />
